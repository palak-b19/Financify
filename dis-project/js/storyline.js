      ...
      triggers: [
        {
          ...
          stepsB: [
            { wait: 2000, opacity: 0.3, transition: "opacity 2000ms ease 0ms" },
          ],
        },
      ],
    },
      ...
      triggers: [
        {
          type: "load",
          stepsA: [
            { transition: "transform 500ms ease 0ms", x: "0px", y: "0px" },
      ...
      triggers: [
        {
          ...
          selector: ".navbar",
          stepsA: [
            { transition: "transform 500ms ease 0ms", x: "0px", y: "-71px" },
            { display: "none" },
          ],
          stepsB: [
            {
